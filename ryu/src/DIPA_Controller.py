...
consumer = client.subscribe('persistent://public/1/mirai',
                            consumer_name='Vm-1 Sub',
                            consumer_type=ConsumerType.Shared,
                            broker_consumer_stats_cache_time_ms=100000)

# Main LAN alert producer
producer = client.create_producer('persistent://public/1/mirai',
                    		  send_timeout_millis=0,
				  compressuin_type=pulsar.CompressionType.ZLib,
