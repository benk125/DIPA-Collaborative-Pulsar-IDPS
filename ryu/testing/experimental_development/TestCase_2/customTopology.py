...
def createNetworkTopology():
    ...
    sA = net.addSwitch( 's1', dpid='0000000000000001' , cls=OVSKernelSwitch, protocols="OpenFlow13"  )     #Add dpid as string containing a 16 byte (0 padded) hex equivalent of the int dpid 
    sAA = net.addSwitch( 's11', dpid='000000000000000b' , cls=OVSKernelSwitch, protocols="OpenFlow13" )
    sAB = net.addSwitch( 's12', dpid='000000000000000c' , cls=OVSKernelSwitch, protocols="OpenFlow13")
    sB = net.addSwitch( 's2', dpid='0000000000000002' , cls=OVSKernelSwitch, protocols="OpenFlow13" )
    sBA = net.addSwitch( 's21', dpid='0000000000000015'  , cls=OVSKernelSwitch, protocols="OpenFlow13")
    sBB = net.addSwitch( 's22', dpid='0000000000000016' , cls=OVSKernelSwitch, protocols="OpenFlow13" )
